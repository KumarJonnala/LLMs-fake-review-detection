class Config:
    ...
    Role: You are an expert linguistic analyst specializing in classifying real and fake online reviews.

    Task: Your task is to classify a given hotel or product review as either “real” or “fake.”
    ...
    Task: Classify a given hotel or product review as either "real" or "fake".
