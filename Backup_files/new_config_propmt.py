class Config:
    ...
    file_path = "/home/aluc31or/LLM_Project/sampled_deceptive_opinion_240.csv"
    model = "gemma:2b"
    # model = "llama3.2:3b"
    ...
    Role
    You are an expert linguistic analyst specializing in classifying truthful and deceptive online reviews.

    Task
    Your task is to classify a given hotel or product review as either “truthful” or “deceptive.”
    ...
    - Deceptive reviews often contain generic or templated language.
    - Deceptive reviews may exaggerate praise or criticism.
    - Marketing-style or promotional wording is a strong indicator of deception.
    - Truthful reviews usually include natural language and specific experiential details.
    ...
    Task
    Classify a given hotel or product review as either "truthful" or "deceptive".
